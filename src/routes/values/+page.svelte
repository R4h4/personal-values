...
<div class="flex flex-col text-center h-screen">
  ...
  <div class="h-full flex flex-col mx-6">
    <div class="h-36 pb-4" style="view-transition-name: page-title;">
      <h1 class="text-3xl font-bold mb-4">Find your core values.</h1>

      <p class="text-lg text-gray-600 mb-4">
        Click on the buttons below to sort the values based on their importance to you.
      </p>
    </div>
